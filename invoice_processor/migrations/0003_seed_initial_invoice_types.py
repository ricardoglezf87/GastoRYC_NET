...
SQL_FORWARD = """
INSERT INTO invoice_processor_invoicetype (name, created_at, updated_at, extraction_rules) VALUES
...
SQL_REVERSE = """
DELETE FROM invoice_processor_invoicetype WHERE name IN ('Vizenter', 'Endesa');
"""

class Migration(migrations.Migration):

    # Añade la dependencia a la migración anterior de invoice_processor
    # Reemplaza '000Y_previous_migration' con el nombre real de la migración anterior
    dependencies = [
        ('invoice_processor', '0002_remove_invoicetype_date_extraction_rule_and_more'),
    ]
