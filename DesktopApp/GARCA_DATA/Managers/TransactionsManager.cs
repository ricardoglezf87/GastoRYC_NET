...
#pragma warning restore CS8603
        ...
        public IEnumerable<Transactions>? GetByAccount(int? id)
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
        ...
        public IEnumerable<Transactions>? GetByAccountOrderByOrdenDesc(int? id)
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
        ...
        public IEnumerable<Transactions>? GetByAccountOrderByOrdenDesc(int? id, int startIndex, int nPage)
        {
            return GetByAccountOrderByOrdenDesc(id)?.Skip(startIndex).Take(nPage);
        }

        public IEnumerable<Transactions>? GetAllOpenned()
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
        ...
        private IEnumerable<Transactions>? GetAllOpennedOrderByOrdenDesc()
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
        ...
        public IEnumerable<Transactions>? GetByPerson(int? id)
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
        ...
        public IEnumerable<Transactions>? GetByInvestmentProduct(int? id)
        {
            using (var unitOfWork = new UnitOfWork(new RycContext()))
            {
                var repository = unitOfWork.GetRepositoryModelBase<Transactions>();
