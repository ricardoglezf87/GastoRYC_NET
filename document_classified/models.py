...
# Definimos documentType ANTES de documentInfo para ayudar a Django
...
class documentInfo(models.Model):
    ...
    # Usar la referencia completa 'document_classified.documentType' es más seguro
    document_type = models.ForeignKey(
        'document_classified.documentType', # Especifica la app
...
class ExtractedData(models.Model):
    # Usar la referencia completa 'document_classified.documentInfo' es más seguro
    document = models.OneToOneField(
        'document_classified.documentInfo', # Especifica la app
        on_delete=models.CASCADE,
        related_name='extracted_data',
        verbose_name="Documento"
    )
    document_date = models.DateField(null=True, blank=True, verbose_name="Fecha Factura")
    ...
    # document_number = models.CharField(max_length=100, blank=True, null=True, verbose_name="Número Factura")
    # ...
