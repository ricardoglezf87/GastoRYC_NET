...
class TransactionsRemindersFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'accountsId' => $this->faker->numberBetween(1, 20),
            'personsId' => $this->faker->numberBetween(1, 30),
            'tagsId' => $this->faker->numberBetween(1, 40),
            'categoriesId' => $this->faker->numberBetween(1, 50),
            'amountIn' => $this->faker->randomFloat(2, 10, 100),
            'amountOut' => $this->faker->randomFloat(2, 10, 100),
            'memo' => $this->faker->sentence,
            'transactionsStatusId' => $this->faker->numberBetween(1, 5),
        ];
    }
}
